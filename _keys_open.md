...
- [ ] 父層指標沒 bump 是今天所有單層 commit 的共同尾巴：UCL_Core ahead 11 / AgentCommands / Tools / BookNotes / WorkMemory / letters 全部各自 commit 完但主專案還指著舊 hash ⇒ 同事 pull 拿到的是舊版。basecamp 今晚就因此以為我沒 commit。要嘛明早第一件 bump，要嘛以後別再單層  <!-- 2026-08-15T15:36:38.716Z -->
